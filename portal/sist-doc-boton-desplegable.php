          ...
          <div class="Grid-item u-md-size3of4">
            <div class="Page-body">
              ...
              <div class="Page-document">
                ...
                <iframe src="iframe-preview.php?comp=botones/boton-desplegable" title="Ejemplo de estructura de botón con desplegable" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                ...
                <iframe src="iframe-preview.php?comp=botones/boton-desplegable-primario" title="Ejemplo de botón con desplegable primario" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                
                <h5 class="u-mb2">Secundario</h5>
                <iframe src="iframe-preview.php?comp=botones/boton-desplegable-secundario" title="Ejemplo de botón con desplegable secundario" class="component-preview u-mb4" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>

                <h4 class="u-mt4 u-mb2">Tamaño</h4>
                <iframe src="iframe-preview.php?comp=botones/boton-desplegable-tamanos" title="Ejemplo de tamaños de botón con desplegable" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
