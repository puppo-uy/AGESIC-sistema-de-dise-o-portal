          ...
          <div class="Grid-item u-md-size3of4">
            <div class="Page-body">
              ...
              <div class="Page-document">
                ...
                <p class="Page-description">Los enlaces permiten al usuario acceder a información, secciones o acciones de baja jerarquía dentro de una interfaz. Se utilizan para ofrecer caminos complementarios o alternativos sin competir visualmente con los botones, manteniendo un peso visual mínimo.</p                <h3 class="u-mt4">Estructura del componente</h3>
                <iframe src="iframe-preview.php?comp=acciones/enlace-icono-izq" title="Ejemplo de estructura de enlace" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
...
<h5 class="u-mb2">Solo texto</h5>
 <iframe src="iframe-preview.php?comp=acciones/enlace-solo-texto" title="Ejemplo de enlace de solo texto" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
...
<h5 class="u-mb2">Texto + icono a la izquierda</h5>
 <iframe src="iframe-preview.php?comp=acciones/enlace-icono-izq" title="Ejemplo de enlace con icono a la izquierda" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
...
<iframe src="iframe-preview.php?comp=acciones/enlace-icono-der" title="Ejemplo de enlace con icono a la derecha" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe> 
...
<h5 class="u-mb2">Enlace externo</h5>
 <iframe src="iframe-preview.php?comp=acciones/enlace-externo" title="Ejemplo de enlace externo" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe> 
<p class="u-mb4">Formato específico para enlaces que dirigen al usuario fuera del dominio o sistema actual. Su función es comunicar de forma explícita que la acción implica abandonar el entorno en el que se encuentra. Debe utilizarse exclusivamente para enlaces externos y no para navegación interna. </p>
                ...
                <div class="u-mt3 u-mb4">
                    <iframe src="iframe-preview.php?comp=acciones/enlace-tamanos" title="Ejemplo de tamaños de enlaces" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                </div>crolling="no"></iframe>
                </div>
                <ul class="List-text">
                    <li>Grande</li>
                    <li>Medio</li>
