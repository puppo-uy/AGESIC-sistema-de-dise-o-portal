            ...
            <div class="Page-body">
              ...
              <div class="Page-document">
                ...
                <h4 class="u-mt3">Barra lateral</h4>
                 <iframe src="iframe-preview.php?comp=nav-lateral" title="Ejemplo de estructura de barra lateral" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 480px;" scrolling="no"></iframe>
                
                <h4 class="u-mt3">Submenú</h4>
                 <iframe src="iframe-preview.php?comp=nav-lateral&force_open=1" title="Ejemplo de submenú lateral expandido" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 480px;" scrolling="no"></iframe>

                <h3 class="u-mt4">Comportamiento</h3>
                <h4 class="u-mt3">Escritorio</h4>
                 <iframe src="../biblioteca/navegacion.php" title="Ejemplo de navegación en pantalla de escritorio" class="component-preview u-mb2 u-mt2" style="width: 100%; border: 1px solid #ddd; min-height: 520px;" scrolling="no"></iframe>
                <ul class="List-text">
                ...
                <h4 class="u-mt4">Móvil</h4>
                 <iframe src="../biblioteca/navegacion.php" title="Ejemplo de navegación en pantalla móvil" class="component-preview u-mb2 u-mt2" style="width: 100%; max-width: 360px; border: 1px solid #ddd; min-height: 520px; margin: 0 auto; display: block;" scrolling="no"></iframe>
                <ul class="List-text">
