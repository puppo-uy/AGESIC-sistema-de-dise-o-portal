          ...
          <div class="Grid-item u-md-size3of4">
            <div class="Page-body">
              ...
              <div class="Page-document">
                ...
                <iframe src="iframe-preview.php?comp=tablas/tabla-estandar" title="Ejemplo de estructura de tabla" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                ...
                <iframe src="iframe-preview.php?comp=tablas/tabla-estandar" title="Ejemplo de tabla estándar" class="component-preview u-mb4" style="width: 100%; border: none; min-height: 80px;" scrolling="auto"></iframe>
                ...
                <iframe src="iframe-preview.php?comp=tablas/treegrid" title="Ejemplo de tabla jerárquica (treegrid)" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 200px;" scrolling="auto"></iframe>
