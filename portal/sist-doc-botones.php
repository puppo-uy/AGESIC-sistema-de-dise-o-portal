            ...
            <div class="Page-body">
              ...
              <div class="Page-document">
                ...
                <h2 class="Page-title">Botones</h2>
                                ...
                                <iframe src="iframe-preview.php?comp=botones/boton-primario" title="Ejemplo de estructura de botón" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                                ...
                                <iframe src="iframe-preview.php?comp=botones/boton-primario" title="Ejemplo de botón primario" class="component-preview u-mb2" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                                ...
                                <iframe src="iframe-preview.php?comp=botones/boton-secundario" title="Ejemplo de botón secundario" class="component-preview u-mb2" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                                ...
                                <iframe src="iframe-preview.php?comp=botones/boton-enlace" title="Ejemplo de botón enlace (terciario)" class="component-preview u-mb2" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                                ...
                                <iframe src="iframe-preview.php?comp=botones/boton-tamanos" title="Ejemplo de tamaños de botón" class="component-preview u-mb3" style="width: 100%; border: none; min-height: 80px;" scrolling="no"></iframe>
                                <ul class="List-text">
                                    <li>Grande (L)</li>
                                    <li>Medio (M)</li>
                                    <li>Chico (S)</li>
