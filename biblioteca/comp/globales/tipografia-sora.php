...
$familia_nombre = 'Sora';
$familia_token = '--tipo-familia-marca';

// Sora no tiene archivo de fuente para el peso Light (300): solo existen
// Regular/Medium/Semibold/Bold/Extrabold, por eso no se incluye acá.
$pesos = [
